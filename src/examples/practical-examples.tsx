				...
				>
					<DialogContent>
						<DialogHeader>
							...
							<DialogDescription>
								Are you ready to create this item?
							</DialogDescription>
						</DialogHeader>
						<div class="flex justify-end gap-2">
							<Button
		...
		<div class="relative">
			...
			<div class="border rounded-lg overflow-hidden">
				...
				<div class="p-4 flex items-center justify-between">
					...
					<Popover>
						<PopoverTrigger asChild>
							<button class="p-2 hover:bg-grey-100 rounded">
								<svg
									width="20"
									height="20"
									viewBox="0 0 24 24"
						...
						<PopoverContent class="w-48 p-2">
							<button
								class="w-full text-left px-3 py-2 hover:bg-grey-100 rounded"
								onClick={() => setDetailsOpen(true)}
							>
								View Details
							</button>
							<button class="w-full text-left px-3 py-2 hover:bg-grey-100 rounded">
								Download
							</button>
							<button class="w-full text-left px-3 py-2 hover:bg-grey-100 rounded">
								Share
							...
							<hr class="my-1" />
							<button class="w-full text-left px-3 py-2 hover:bg-grey-100 rounded text-destructive">
								Delete
							</button>
						</PopoverContent>
					</Popover>
