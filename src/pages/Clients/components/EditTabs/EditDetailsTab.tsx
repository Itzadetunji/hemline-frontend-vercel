    ...
    <>
      ...
      <ul class="mt-7 flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-1">
          ...
          {formMethods.formState.errors.client?.gender && <p class="text-destructive text-xs">{formMethods.formState.errors.client.gender.message}</p>}
        </div>
        ...
        <div className="flex flex-col gap-1">
          ...
          {formMethods.formState.errors.client?.phone_number && <p class="text-destructive text-xs">{formMethods.formState.errors.client.phone_number.message}</p>}
        </div>
        <div className="flex flex-col gap-1">
          <Label class="flex flex-col items-stretch gap-4">
          ...
          {formMethods.formState.errors.client?.email && <p class="text-destructive text-xs">{formMethods.formState.errors.client.email.message}</p>}
        </div>
      </ul>
