        ...
        return (
            <div class="flex flex-col items-stretch flex-1">
                <button class="flex items-center gap-2" type="button">
                    ...
                    <p class="text-sm font-medium">What is a folder?</p>
                </button>
                <div class="flex flex-col flex-1 justify-center items-center gap-4">
                    <div class="flex flex-col gap-4 items-center">
                        <h2 class="leading-0 text-2xl">Folder is empty</h2>
                        <p class="text-grey-500 font-medium text-sm text-center max-w-8/10">Create a folder by selecting from your uploaded works</p>
                    </div>
