...
export const UploadImages = () => {
    ...
    return (
        <>
            <li>
                <button onClick={handleButtonClick} class="p-1 min-w-5" disabled={uploadImagesMutation.isPending} type="button">
                        ...
                        {uploadImagesMutation.isPending && (
                            <>
                                ...
                                <div class="flex items-center gap-1.5">
                                    ...
                                    <p class="text-sm font-medium">{Math.round(uploadImagesMutation.progress)}%</p>
                                </div>
                            </>
                        )}
