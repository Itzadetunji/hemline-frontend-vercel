...
export const VerifyEmail = () => {
    ...
    return (
        <main class="flex flex-col h-[100dvh] px-4 py-4 gap-9.5 items-stretch">
            ...
            <form class="flex flex-col gap-6 flex-1" onSubmit={handleSubmit}>
                <Label class="flex flex-col gap-4 items-stretch">
                    <div class="flex flex-col gap-4">
                        <h2 class="text-2xl leading-0">Login with Otp</h2>
                        <p class="text-sm font-medium text-grey-400">Enter the six digit code we sent with the link below.</p>
                    </div>
                    ...
                    {formMethods.formState.errors.code && <p class="text-xs text-red-500">{formMethods.formState.errors.code.message}</p>}
                </Label>
...
const ResendEmail = () => {
    ...
    return (
        <div class="text-sm self-center text-center text-grey-400 flex flex-col gap-2">
            {emailSent ? (
                ...
                <p>
                    ...
                    <button
                        ...
                        disabled={isDisabled}
                        className={`underline text-black ${isDisabled ? "opacity-50 cursor-not-allowed" : ""}`}
                    >
                        Resend
                    </button>
                </p>
            ...
            >
                Wrong Email?
                <span class="underline text-black">Change Email</span>
            </button>
        </div>
    );
};
