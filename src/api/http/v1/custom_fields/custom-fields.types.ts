import { z } from "zod";
import type { CustomField as ExistingCustomField, CustomFieldData as ExistingCustomFieldData } from "@/api/http/v1/users/users.types";
...
export const UpdateCustomFieldSchema = z.object({
  custom_field: z.object({
    ...
    field_type: z.enum(CustomFieldAttributeType, { error: "Kindly select a type" }).optional(),
    is_active: z.boolean().optional(),
  }),
});
