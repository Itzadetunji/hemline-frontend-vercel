...
const FOLDERS_ENDPOINTS = {
  ...
  removeImagesFromFolder: (id: string) => `/gallery/folders/${id}/remove_images`,
  ...
  getPublicFolderImages: (publicId: string) => `/public/folders/${publicId}/images`,
} as const;
...
export const FOLDERS_API = {
  ...
  GET_FOLDER: async (id: string, params?: PaginationParams): Promise<GetFolderResponse> =>
    await $http
  ...
  SHARE_FOLDER: async (id: string, data: ShareFolderPayload): Promise<ShareFolderResponse> => await $http.post(FOLDERS_ENDPOINTS.shareFolder(id), data).then((res) => res.data),

  GET_PUBLIC_FOLDER: async (publicId: string, params?: PaginationParams): Promise<GetPublicFolderResponse> =>
    await $http
  ...
  GET_PUBLIC_FOLDER_IMAGES: async (publicId: string, params?: PaginationParams): Promise<GetPublicFolderImagesResponse> =>
    await $http
