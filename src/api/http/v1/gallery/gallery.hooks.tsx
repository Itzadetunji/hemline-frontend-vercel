...
export const useUploadImages = () => {
  ...
  const mutation = useMutation<UploadImagesResponse, AxiosError<{ error: string; errors?: string[] }>, FormData>({
...
export const useUpdateGalleryImage = () => {
  ...
  return useMutation<UpdateGalleryImageResponse, AxiosError<{ error: string; errors?: string[] }>, { id: string; data: UpdateGalleryImagePayload }>({
...
export const useDeleteImages = () => {
  ...
  return useMutation<DeleteImagesResponse, AxiosError<{ error: string; errors?: string[] }>, DeleteImagesPayload>({
