...
export type RequestMagicLinkPayload = z.infer<typeof RequestMagicLinkPayloadSchema>;
...
export const OnboardingFormSchema = z.object({
  ...
  skills: z.array(z.enum(SkillChoices)).min(1, "At least one skill is required"),
